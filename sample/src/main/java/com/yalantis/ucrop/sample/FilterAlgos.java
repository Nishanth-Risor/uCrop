...
import static com.yalantis.ucrop.Filters.ImageFilters.COLOR_MAX;

public class FilterAlgos {


    private static final float COLOR_MIN =0 ;
    ...
    public Bitmap applyInvertEffect(Bitmap src) {
     ...
     public Bitmap applyGrayEffect(Bitmap bm)
     {
         Bitmap result=bm.copy(bm.getConfig(), true);
             ...
             for(int j=0;j<result.getHeight();j++)
             {
               int  pixel=result.getPixel(i, j);
                ...
                int G =  Color.green(pixel);
                 ...
                 // set newly-inverted pixel to output image
                 int gray=(R+G+B)/3;
                 result.setPixel(i, j, Color.argb(A, gray, gray, gray));
             }
         }
